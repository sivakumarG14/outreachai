...
const s = {
  ...
  leadName: { fontWeight: 600, color: 'var(--text)', fontSize: 14, fontFamily: "'Outfit',sans-serif", maxWidth: '180px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  leadEmail: { color: 'var(--text3)', fontSize: 12, marginTop: 1, maxWidth: '200px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  companyTag: { background: 'var(--brand-gold-glow)', color: 'var(--brand-gold-light)', padding: '3px 10px', borderRadius: 6, fontSize: 12, fontWeight: 500, display: 'inline-flex', alignItems: 'center', gap: 4, border: '1px solid rgba(201,168,76,0.08)', maxWidth: '200px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  badge: { display: 'inline-flex', alignItems: 'center', gap: 5, padding: '4px 10px', borderRadius: 20, fontSize: 11, fontWeight: 600, maxWidth: '150px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
